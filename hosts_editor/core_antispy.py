...
class AntiSpyManager:
    ...
    def enable_item(item_id: str, _reset: bool = True,
        ...
        try:
            ...
            AntiSpyManager._set_flag(loader, saver, item_id, True, missing=False)
        ...
        try:
            ...
            if kind == "hklm_reg":
                ...
                if _svc_info_cache is not None and item["service"] in _svc_info_cache:
                    ...
                    svc_exists = AntiSpyManager._service_exists(item["service"])
                if svc_exists:
                    if not AntiSpyManager._restore_service(item["service"], "auto"):
    ...
    @staticmethod
    def _set_flag(loader, saver, item_id: str, active: bool, missing: Optional[bool] = None) -> None:
        items = loader()
